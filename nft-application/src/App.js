...
// 合约地址
const MYNFT_ADDRESS = "0xb6FceA75cB55F924210fadfE6Cb93F8347883aaa";
const MARKET_ADDRESS = "0x9Ddf4f1dB549E375475F0E1921CfF87C8180aD04";
    ...
    <div className="App">
      ...
      {!account ? (
        ...
        <div>
          ...
          <button className="button" onClick={mintNFT} disabled={loading}>
            {loading ? '铸造中...' : '铸造 NFT'}
          </button>
          ...
          <button className="button" onClick={listNFTForSale} disabled={loading}>
            {loading ? '出售中...' : '出售 NFT'}
          </button>
          ...
          {nftsForSale.length === 0 ? (
            ...
            <div className="nft-gallery">
              {nftsForSale.map(({ tokenId, price }) => (
                <div className="listBox" key={tokenId.toString()}>
                  <div className="listTitle">
                    <h3>Token ID: {tokenId.toString()}</h3>
                  </div>
                  <div className="listRemark">
