...
//  合约地址
const UNIVERSAL_POINTS_ADDRESS = "0x5D7d6Fd973D2176244fb52305A84dA91b859b3B2";
const POINTS_EXCHANGE_ADDRESS  = "0xE6B5671238220e805fb7230664dd3592bA726930";
...
function App() {
  ...
  return (
    <div className="App">
      ...
      {!isWalletConnected ? (
        <div>
          <button onClick={connectWallet}>连接到钱包</button>
        </div>
      ) : (
        <div>
          {/* 钱包连接后显示的内容 */}
